<%@page import="com.PIZZA.entities.Admin"%>
<%@page import="com.PIZZA.entities.Cart"%>
<%@page import="com.PIZZA.dao.CartDao"%>
<%@page import="com.PIZZA.entities.User"%>
<%@page import="java.util.List"%>
<%@page import="com.PIZZA.entities.Category"%>
<%@page import="com.PIZZA.helper.ConnectionProvider"%>
<%@page import="com.PIZZA.dao.CategoryDao"%>
<%
...
<nav class="navbar navbar-expand-lg custom-color" data-bs-theme="dark">
	...
	<div class="container">
		<a class="navbar-brand" href="admin.jsp"><i
			class="fa-sharp fa-solid fa-house" style="color: #ffffff;"></i>&ensp;QrShop</a>
